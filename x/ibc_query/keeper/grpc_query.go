...
func (k Keeper) CrossChainQueryResult(c context.Context, req *types.QueryCrossChainQueryResult) (*types.QueryCrossChainQueryResultResponse, error) {
	...
	return &types.QueryCrossChainQueryResultResponse{Id: req.Id, Result: queryResult.Result, Data: queryResult.Data, Sender: queryResult.Sender, QuerySender: queryResult.QuerySender}, nil
