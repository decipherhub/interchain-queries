...
func NewMsgSubmitCrossChainQueryResult(id string, queryHeight uint64, result QueryResult, data []byte, querySender string, proofs []*ics23.ProofSpec) *MsgSubmitCrossChainQueryResult {
