...
func NewMsgSubmitCrossChainQueryResult(id string, queryHeight uint64, result QueryResult, data []byte, sender string, proofs []*ics23.ProofSpec) *MsgSubmitCrossChainQueryResult {
