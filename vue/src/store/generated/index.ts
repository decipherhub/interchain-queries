...
import CosmosInterchainQueriesIbcApplicationsIbcQueryV1 from './cosmos/interchain-queries/ibc.applications.ibc_query.v1'
import CosmosInterchainQueriesIbcQueryV1 from './cosmos/interchain-queries/ibc_query.v1'
...
export default { 
  ...
  CosmosInterchainQueriesIbcApplicationsIbcQueryV1: load(CosmosInterchainQueriesIbcApplicationsIbcQueryV1, 'ibc.applications.ibc_query.v1'),
  CosmosInterchainQueriesIbcQueryV1: load(CosmosInterchainQueriesIbcQueryV1, 'ibc_query.v1'),
