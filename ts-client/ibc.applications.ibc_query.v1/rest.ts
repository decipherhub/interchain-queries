...
export interface V1CrossChainQuery {
  id?: string;
  path?: string;
   ...
   * gets reset
   */
  local_timeout_height?: V1Height;

  /** @format uint64 */
  local_timeout_timestamp?: string;
...
export interface V1MsgSubmitCrossChainQueryResponse {
   ...
   */
  cap_key?: V1Beta1Capability;
}

export type V1MsgSubmitCrossChainQueryResultResponse = object;

export interface V1MsgSubmitPruneCrossChainQueryResultResponse {
  id?: string;
...
export interface V1QueryCrossChainQueryResponse {
  result?: V1CrossChainQuery;
}
...
provided to a Capability must be globally unique.
*/
export interface V1Beta1Capability {
  /** @format uint64 */
  index?: string;
}
...
/**
 * @title ibc/applications/ibc_query/v1/crosschainquery.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryCrossChainQuery
   * @summary query CrossChainQuery
   * @request GET:/ibc/apps/ibc_query/v1/{id}
   */
  queryCrossChainQuery = (id: string, params: RequestParams = {}) =>
    this.request<V1QueryCrossChainQueryResponse, RpcStatus>({
      path: `/ibc/apps/ibc_query/v1/${id}`,
      method: "GET",
      format: "json",
      ...params,
    });
